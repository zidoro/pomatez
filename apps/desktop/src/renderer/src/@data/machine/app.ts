...
export const createAppMachine = (
  defaultMachineContextData: MachineContextProps
) =>
  createMachine(
    {
      /** @xstate-layout N4IgpgJg5mDOIC5QEMAOqDEBjA9gOwDMBLKAOiwAtk8YBtABgF1FRUdYiAXI---VljyGG+RVFHpKkKTyNKqamWMyZbkotj4RddnVHKsA4OeECkLAqBgMgyFQgA8ilH1fWCt4Pk+k5Zb54piBGsjDH8MSWDY7wKLMAXzWmNjioln14N9v3--A8Qi14x8FQE3vm-j7+IvGS5i0pKIkjVa6jDLGCS196XUQBPoapMmryKKaOdJO365rCmkfiNY6SpiItdgETu9eyoQUpkm-SUS6i9pyky9RkkaSi05LWx+g1ZO2lm7FykAFY0- */
      ...
      tsTypes: {} as import("./app.typegen").Typegen1,
...
const defaultContextAtom = atomWithStorage<MachineContextProps>(
  SYNC_DATA_STORAGE_NAME,
  defaultMachineContextData
);

export const appMachineAtom = atomWithMachine((get) =>
  createAppMachine(get(defaultContextAtom))
);
