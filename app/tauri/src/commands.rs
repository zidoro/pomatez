...
use tauri::{Builder, LogicalSize, Manager, Runtime, Wry};
...
#[tauri::command]
fn minimize_window<R: Runtime>(minimize_to_tray: bool, window: tauri::WebviewWindow<R>) {
...
#[tauri::command]
fn close_window<R: Runtime>(close_to_tray: bool, window: tauri::WebviewWindow<R>) {
...
#[tauri::command]
fn show_window<R: Runtime>(_window: tauri::WebviewWindow<R>) {
    println!("set_show!");
}
