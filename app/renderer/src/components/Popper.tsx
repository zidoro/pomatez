...
import { StyledPopper, StyledPopperContent, StyledPopperHeader } from "styles";
...
export const Popper: React.FC<Props> = ({ showPopper, content, children }) => {
	const popperRef = useRef<HTMLDivElement>(null);
	const contentRef = useRef<HTMLDivElement>(null);
	const targetRef = useRef<HTMLElement>(null);

	const [showContent, setShowContent] = useTargetOutside({ ref: popperRef });
